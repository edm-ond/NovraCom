                ...
                ${products
                    ...
                    <div class="product-card bg-white rounded-lg shadow-md overflow-hidden" 
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex justify-between items-center">
                                <div class="text-xl font-bold">Ksh${
                                    product.price
                                }</div>
        ...
        <div class="pb-16">
            ...
            <div class="bg-white p-4 mb-4">
                <div class="flex justify-between items-start mb-4">
                    ...
                    <div class="text-3xl font-bold text-green-500">Ksh${
        ...
        <div class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
            <div class="bg-white rounded-lg w-full max-w-lg max-h-[90vh] overflow-y-auto">
                <div class="p-4">
                    ...
                    <div class="flex justify-between items-center mb-4">
                        <div class="text-2xl font-bold">Ksh${product.price}</div>
                        <div class="flex items-center">
                            <span class="mr-1">${product.rating}</span>
                            <i class="fas fa-star text-yellow-400"></i>
                        </div>
            ...
            <form id="deliveryForm" class="p-4 space-y-6" onsubmit="event.preventDefault(); placeOrder();">
                ...
                <div class="fixed bottom-0 left-0 right-0 bg-white border-t shadow-lg p-4">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <div class="text-xl font-bold">Ksh${finalTotal}</div>
                    </div>
                    <button type="submit"
                ...
                <div class="bg-white p-4 mb-4">
                    ...
                    <div class="space-y-2">
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium">Ksh${calculateSubtotal()}</span>
                        </div>
                        <div class="flex justify-between">
                        ...
                        <div class="border-t pt-2 mt-2">
                            <div class="flex justify-between">
                                ...
                                <span class="font-bold text-xl">Ksh${calculateSubtotal()}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            ${
                ...
                <div class="fixed bottom-0 left-0 right-0 bg-white p-4 shadow-lg">
                    <button onclick="checkout()" 
                            class="w-full bg-green-500 text-white py-3 rounded-lg font-semibold flex items-center justify-center">
                        <i class="fas fa-lock mr-2"></i>
                        Proceed to Checkout (Ksh${calculateSubtotal()})
                    </button>
                </div>
            `
                    : ''
